...
export const authAPI = {
    ...
    getMe: () => apiCall<{ success: boolean; data: { user: any } }>('/auth/me'),
...
export const projectsAPI = {
    getAll: () => apiCall<{ success: boolean; count: number; data: any[] }>('/projects'),
    getById: (id: string) =>
...
export const filesAPI = {
    ...
    delete: (id: string) =>
        apiCall(`/files/${id}`, { method: 'DELETE' }),
};
// ======== USERS API (Admin) ========
export const usersAPI = {
    getAll: () => apiCall<{ success: boolean; count: number; data: any[] }>('/users'),
